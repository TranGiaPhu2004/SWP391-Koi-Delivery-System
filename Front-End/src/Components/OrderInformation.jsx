...
function PriceList() {
  ...
  const decrement1 = () => {
    if (count1 > 0) {
      ...
      alert(
        "Sorry, you could not decrement when amount of boxes begin from Zero ..."
      );
    }
  };
  const decrement2 = () => {
  ...
  return (
    <>
      ...
      <div className="PriceList-BoxChoosing">
        ...
        <div className="PriceList-BoxChoosing">
          <div className="PriceList-paymentmethods">Delivery Categories</div>
